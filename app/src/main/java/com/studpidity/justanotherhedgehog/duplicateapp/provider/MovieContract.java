package com.studpidity.justanotherhedgehog.duplicateapp.provider;
...
public class MovieContract {
    public static final String CONTENT_AUTHORITY = "com.studpidity.justanotherhedgehog.duplicateapp";
